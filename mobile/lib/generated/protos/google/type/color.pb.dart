...
class Color extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Color', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.type'), createEmptyInstance: create)
    ...
    ..aOM<$17.FloatValue>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alpha', subBuilder: $17.FloatValue.create)
  ...
  @$pb.TagNumber(4)
  $17.FloatValue get alpha => $_getN(3);
  @$pb.TagNumber(4)
  set alpha($17.FloatValue v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAlpha() => $_has(3);
  @$pb.TagNumber(4)
  void clearAlpha() => clearField(4);
  @$pb.TagNumber(4)
  $17.FloatValue ensureAlpha() => $_ensure(3);
}
