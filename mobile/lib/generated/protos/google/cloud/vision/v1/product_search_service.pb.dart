...
class ProductSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProductSet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.vision.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<$14.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'indexTime', subBuilder: $14.Timestamp.create)
    ..aOM<$12.Status>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'indexError', subBuilder: $12.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $14.Timestamp get indexTime => $_getN(2);
  @$pb.TagNumber(3)
  set indexTime($14.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasIndexTime() => $_has(2);
  @$pb.TagNumber(3)
  void clearIndexTime() => clearField(3);
  @$pb.TagNumber(3)
  $14.Timestamp ensureIndexTime() => $_ensure(2);

  @$pb.TagNumber(4)
  $12.Status get indexError => $_getN(3);
  @$pb.TagNumber(4)
  set indexError($12.Status v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasIndexError() => $_has(3);
  @$pb.TagNumber(4)
  void clearIndexError() => clearField(4);
  @$pb.TagNumber(4)
  $12.Status ensureIndexError() => $_ensure(3);
}
...
class ReferenceImage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReferenceImage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.vision.v1'), createEmptyInstance: create)
    ...
    ..pc<$15.BoundingPoly>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boundingPolys', $pb.PbFieldType.PM, subBuilder: $15.BoundingPoly.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ReferenceImage({
    $core.String? name,
    $core.String? uri,
    $core.Iterable<$15.BoundingPoly>? boundingPolys,
  }) {
    final _result = create();
    if (name != null) {
      _result.name = name;
  ...
  @$pb.TagNumber(3)
  $core.List<$15.BoundingPoly> get boundingPolys => $_getList(2);
}
...
class ImportProductSetsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImportProductSetsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.vision.v1'), createEmptyInstance: create)
    ..pc<ReferenceImage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'referenceImages', $pb.PbFieldType.PM, subBuilder: ReferenceImage.create)
    ..pc<$12.Status>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'statuses', $pb.PbFieldType.PM, subBuilder: $12.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ImportProductSetsResponse({
    $core.Iterable<ReferenceImage>? referenceImages,
    $core.Iterable<$12.Status>? statuses,
  }) {
    final _result = create();
    if (referenceImages != null) {
      _result.referenceImages.addAll(referenceImages);
  ...
  @$pb.TagNumber(2)
  $core.List<$12.Status> get statuses => $_getList(1);
}
