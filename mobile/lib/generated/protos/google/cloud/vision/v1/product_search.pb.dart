...
class ProductSearchParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProductSearchParams', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.vision.v1'), createEmptyInstance: create)
    ...
    ..aOM<$15.BoundingPoly>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boundingPoly', subBuilder: $15.BoundingPoly.create)
  ...
  @$pb.TagNumber(9)
  $15.BoundingPoly get boundingPoly => $_getN(3);
  @$pb.TagNumber(9)
  set boundingPoly($15.BoundingPoly v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasBoundingPoly() => $_has(3);
  @$pb.TagNumber(9)
  void clearBoundingPoly() => clearField(9);
  @$pb.TagNumber(9)
  $15.BoundingPoly ensureBoundingPoly() => $_ensure(3);
}
...
class ProductSearchResults_Result extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProductSearchResults.Result', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.vision.v1'), createEmptyInstance: create)
    ..aOM<$4.Product>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'product', subBuilder: $4.Product.create)
  ...
  @$pb.TagNumber(1)
  set product($4.Product v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasProduct() => $_has(0);
  @$pb.TagNumber(1)
  void clearProduct() => clearField(1);
  @$pb.TagNumber(1)
  $4.Product ensureProduct() => $_ensure(0);
...
class ProductSearchResults extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProductSearchResults', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.vision.v1'), createEmptyInstance: create)
    ..aOM<$14.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'indexTime', subBuilder: $14.Timestamp.create)
  ...
  @$pb.TagNumber(2)
  $14.Timestamp get indexTime => $_getN(0);
  @$pb.TagNumber(2)
  set indexTime($14.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasIndexTime() => $_has(0);
  @$pb.TagNumber(2)
  void clearIndexTime() => clearField(2);
  @$pb.TagNumber(2)
  $14.Timestamp ensureIndexTime() => $_ensure(0);
