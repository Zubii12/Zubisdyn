...
class Block extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Block', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.vision.v1'), createEmptyInstance: create)
    ..aOM<TextAnnotation_TextProperty>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'property', subBuilder: TextAnnotation_TextProperty.create)
    ..aOM<$15.BoundingPoly>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boundingBox', subBuilder: $15.BoundingPoly.create)
  ...
  @$pb.TagNumber(2)
  $15.BoundingPoly get boundingBox => $_getN(1);
  @$pb.TagNumber(2)
  set boundingBox($15.BoundingPoly v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBoundingBox() => $_has(1);
  @$pb.TagNumber(2)
  void clearBoundingBox() => clearField(2);
  @$pb.TagNumber(2)
  $15.BoundingPoly ensureBoundingBox() => $_ensure(1);
