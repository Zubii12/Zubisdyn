...
import '../../../../protobuf/struct.pbenum.dart' as $23;

class DocumentEventData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DocumentEventData', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.events.cloud.firestore.v1'), createEmptyInstance: create)
    ..aOM<Document>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', subBuilder: Document.create)
    ..aOM<Document>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'oldValue', subBuilder: Document.create)
    ..aOM<DocumentMask>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateMask', subBuilder: DocumentMask.create)
  ...
  'Will be removed in next major version')
  DocumentEventData copyWith(void Function(DocumentEventData) updates) => super.copyWith((message) => updates(message as DocumentEventData)) as DocumentEventData; // ignore: deprecated_member_use
...
class DocumentMask extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DocumentMask', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.events.cloud.firestore.v1'), createEmptyInstance: create)
...
class Document extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Document', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.events.cloud.firestore.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..m<$core.String, Value>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fields', entryClassName: 'Document.FieldsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: Value.create, packageName: const $pb.PackageName('google.events.cloud.firestore.v1'))
    ..aOM<$14.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $14.Timestamp.create)
    ..aOM<$14.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $14.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $14.Timestamp get createTime => $_getN(2);
  @$pb.TagNumber(3)
  set createTime($14.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCreateTime() => $_has(2);
  @$pb.TagNumber(3)
  void clearCreateTime() => clearField(3);
  @$pb.TagNumber(3)
  $14.Timestamp ensureCreateTime() => $_ensure(2);

  @$pb.TagNumber(4)
  $14.Timestamp get updateTime => $_getN(3);
  @$pb.TagNumber(4)
  set updateTime($14.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasUpdateTime() => $_has(3);
  @$pb.TagNumber(4)
  void clearUpdateTime() => clearField(4);
  @$pb.TagNumber(4)
  $14.Timestamp ensureUpdateTime() => $_ensure(3);
}
...
class Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Value', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.events.cloud.firestore.v1'), createEmptyInstance: create)
    ...
    ..aOM<$18.LatLng>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'geoPointValue', subBuilder: $18.LatLng.create)
    ..aOM<ArrayValue>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'arrayValue', subBuilder: ArrayValue.create)
    ..aOM<$14.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timestampValue', subBuilder: $14.Timestamp.create)
    ..e<$23.NullValue>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nullValue', $pb.PbFieldType.OE, defaultOrMaker: $23.NullValue.NULL_VALUE, valueOf: $23.NullValue.valueOf, enumValues: $23.NullValue.values)
  ...
  factory Value({
    ...
    MapValue? mapValue,
    $18.LatLng? geoPointValue,
    ArrayValue? arrayValue,
    $14.Timestamp? timestampValue,
    $23.NullValue? nullValue,
  ...
  @$pb.TagNumber(8)
  $18.LatLng get geoPointValue => $_getN(5);
  @$pb.TagNumber(8)
  set geoPointValue($18.LatLng v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasGeoPointValue() => $_has(5);
  @$pb.TagNumber(8)
  void clearGeoPointValue() => clearField(8);
  @$pb.TagNumber(8)
  $18.LatLng ensureGeoPointValue() => $_ensure(5);
  ...
  @$pb.TagNumber(10)
  set timestampValue($14.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  $23.NullValue get nullValue => $_getN(8);
  @$pb.TagNumber(11)
  set nullValue($23.NullValue v) { setField(11, v); }
  @$pb.TagNumber(11)
...
class ArrayValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ArrayValue', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.events.cloud.firestore.v1'), createEmptyInstance: create)
...
class MapValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MapValue', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.events.cloud.firestore.v1'), createEmptyInstance: create)
    ..m<$core.String, Value>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fields', entryClassName: 'MapValue.FieldsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: Value.create, packageName: const $pb.PackageName('google.events.cloud.firestore.v1'))
    ..hasRequiredFields = false
  ;
